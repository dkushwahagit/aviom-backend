<div class="leftBox">
    <div class="userSection">
      <div class="userPic"><img class="img-responsive img-circle" src="assets/images/user-pic.png" alt="User Pic"/></div>
    ...
    <nav>
      <ul>
        ...
        <li><a href="my-properties.html"><em class="icon-my-properties"></em> <span>My Properties</span> </a></li>
        <li><a href="my-loans.html"><em class="icon-my-loans"></em> <span>My Loans</span> </a></li>
        <li><a href="service-requests.html"><em class="icon-service-request"></em> <span>Service Requests</span> </a></li>
        <li><a href="my-credit-notes.html"><em class="icon-my-cradit-notes"></em> <span>My Credit Notes</span> </a></li>
