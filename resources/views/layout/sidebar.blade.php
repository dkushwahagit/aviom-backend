<div class="leftBox">
    ...
    <nav>
      <ul>
        ...
        ?>
        <li><a href="{{url('/my-investments')}}"><em class="icon-my-properties"></em> <span>My Investments</span> </a></li>
        <li><a href="{{url('/square-news')}}"><em class="icon-my-loans"></em> <span>Square News</span> </a></li>
        <?php
         }
        ?>
        <li><a href="{{url('/service-request-list')}}"><em class="icon-service-request"></em> <span>Service Requests</span> </a></li>
